...
?><div class="ps-widget--members__wrapper ps-widget__wrapper<?php echo $instance['class_suffix']; ?> ps-widget<?php echo $instance['class_suffix']; ?> ps-js-widget-latest-members"
    ...
    <div class="ps-widget__body<?php echo $instance['class_suffix']; ?>">
        <div class="ps-widget--members ps-js-widget-content" id="<?php echo $config['id'];?>">
