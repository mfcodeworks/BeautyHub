...
class PeepSoGdprListTable extends PeepSoListTable 
{
	...
	public function get_columns()
	{
		return array(
			...
			'request_id' => 'ID',
			'request_user_id' => __('User Requester', 'peepso-core'),
			'request_created_at' => __('Date Created', 'peepso-core'),
			'request_updated_at' => __('Date Updated', 'peepso-core'),
	...
	{
		return array(
			'request_id' => array('request_id', false), 
			'request_updated_at' => array('request_updated_at', false), 
