...
class PeepSoConfigSectionAppearance extends PeepSoConfigSectionAbstract
{
	...
	private function _group_template() {
        ...
        $this->set_field(
            'site_css_rounded',
            __('Rounded corners', 'peepso-core'),
            'yesno_switch'
        );
	...
	private function _group_general()
	{
        ...
        $this->args('descript', __('"Relative" date is a human readable date, for example "3 days ago"','peepso-core').'<br/>'.sprintf(__('"Absolute" date is a simple datestamp such as %s','peepso_core'), date(get_option('date_format').' '.get_option('time_format'))));
        $this->set_field(
            'absolute_dates',
