...
class PeepSoRegisterShortcode
{
	...
	public function do_shortcode($atts, $content)
	{
        ...
        if(get_current_user_id() && !isset($_GET['peepso_activate'])) {
...
//		$wp_query->is_page = FALSE;
	...
	public function enqueue_scripts()
	{
		...
		wp_register_script('peepso-register', PeepSo::get_asset('js/register.min.js'), array('jquery', 'underscore', 'peepso-form'), PeepSo::PLUGIN_VERSION, TRUE);
