...
class PeepSoConfig
{
	...
	public function get_tabs()
	{
		...
		if (PeepSo::get_option('location_enable', 0) == 1) {
			$default_tabs['location'] = array(
				'label' => __('Location', 'peepso-core'),
				'icon' => 'https://www.peepso.com/wp-content/plugins/peepso.com-checkout/assets/icons/237.svg',
				'tab' => 'location',
				'description' => '',
