	...
	public function __construct( $post , $user_id = NULL )
	{
		...
		foreach ($this->field_meta_keys as $meta) {
			...
			if('privacywarningtext' == $meta && !strlen($this->meta->$meta)) {
			    $this->meta->$meta = __('Stay safe! Be careful about disclosing personal information.','profileso');
            }
		}
			...
			<div class="ps-privacy-dropdown ps-js-dropdown">
				...
				<div class="ps-dropdown__menu ps-js-dropdown-menu">
					<?php foreach ($access_settings as $acc_key => $acc_value) { ?>
						<a href="javascript:" id="<?php echo $this->id . '-acc-' . $acc_key ?>" data-option-value="<?php echo $acc_key; ?>" onclick="profile.change_privacy(this);">
