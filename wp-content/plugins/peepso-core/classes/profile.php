    ...
    public function download_account_data(PeepSoAjaxResponse $resp)
    {
        ...
        if ( $user && wp_check_password( $pass, $user->data->user_pass, $user->ID ) ) {
            if($this->can_edit()) {
                ...
                $url = $this->user->get_personaldata_url() . $this->user->get_username() .'.zip';
...
//			echo		$aAttr['label'], PHP_EOL;
    ...
    public function request_data_form()
    {
        ...
        if($can_edit) {
            ...
            $fields['submit'] = array(
                'label' => __('Export my Community information', 'peepso-core'),
                'class' => 'ps-btn-danger',
