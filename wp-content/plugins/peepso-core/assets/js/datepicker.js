(function( $ ) {
	...
	function attachEvents( inst ) {
		...
		$month.on( 'change.ps-datepicker', { inst: inst }, changeMonthHandler );
		$year.on( 'change.ps-datepicker', { inst: inst }, changeMonthHandler );
	...
	function detachEvents( inst ) {
		...
		$month.off( 'change.ps-datepicker' );
		$year.off( 'change.ps-datepicker' );
