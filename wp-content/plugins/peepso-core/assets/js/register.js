...
function validate( ct ) {
	var $ct = $( ct ),
		$input = $ct.find('input[type=text],input[type=email],input[type=password],input[type=checkbox],input[type=radio],textarea,select'),
...
function doSubmit( form ) {
	...
	$.when.apply( $, deferreds ).done(function() {
		...
		if ( $fields.length ) {
			$fields.each(function() {
				$input = $( this ).find('input[type=text],input[type=email],input[type=password],input[type=checkbox],input[type=radio],textarea,select');
...
$form
	...
	.on('input', 'input[type=text]:not(.ps-js-field-location),input[type=email],input[type=password],textarea', _.debounce(function( e ) {
...
if ( $consents.length ) {
	$consents.on('click.ps-register-consent', function( e ) {
		var checked = [];
